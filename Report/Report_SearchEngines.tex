...
\subsection{Ranking}
\subsubsection{Ranking based on Title, Categories and Businesses}
...
\subsubsection{Ranking based on Geographic Location}
...
\subsection{Querying businesses}
\subsection{Querying businesses based on key-words}
\subsection{Geographic Location based Searching}
\section{Evaluation}
