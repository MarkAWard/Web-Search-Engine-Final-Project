...
\section{Evaluation}
Query that we tested upon are shown in the table below.


Figures 1-4 represent the Evaluation. Figure 1 and Figure 2 shows the Accuracy and NDCG at 5 for the queries in different regions.
Figure 3 and Figure 4 show the average Accuracy and NDCG for all the queries tested.
